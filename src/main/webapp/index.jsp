...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="img/hos3.jpg" class="d-block w-100" alt="..." height="550px">
    </div>
  </div>
...
<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doc5.jpg" height="300px">
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Vishal Singh</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Jack</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. KavyaShree</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Bhoomika</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
